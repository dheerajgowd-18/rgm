      ...
      <div className="relative z-10 container mx-auto px-4">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/5 border border-primary/10 text-primary text-[10px] font-bold uppercase tracking-widest mb-4"
          >
          ...
          <motion.h1
            ...
            className="text-4xl md:text-7xl font-black mb-6 tracking-tight text-balance leading-[0.9] text-slate-900"
          >
            13<span className="text-primary font-serif italic">th</span> JNTUA <br />
            <span className="text-secondary italic">INTER COLLEGIATE</span> <br />
            GAMES MEET 2026
          </motion.h1>
          ...
          <motion.p
            ...
            className="text-base md:text-xl text-slate-600 mb-8 max-w-2xl mx-auto font-medium"
          >
